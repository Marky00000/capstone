        ...
        <div class="modal-content">
            <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <img id="serviceImage" src="" alt="Service Image" style="width: 100%; height: auto; border: 1px solid #ccc;">
                        </div>
                    </div>
                    <div class="vertical-divider"></div>
                    <div class="col-md-5">
                        <div class="text-left">
                            <h3 id="serviceName" class="mt-3" style="font-family: Arial, Helvetica, sans-serif; font-weight: bold;"></h3>
                            <p id="serviceDescription" style="font-family: Arial, Helvetica, sans-serif; font-size: 1rem; line-height: 1.5;"></p>
                        </div>
                    </div>
                </div>
            </div>
