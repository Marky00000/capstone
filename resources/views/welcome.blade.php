...
<!-- Carousel -->
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="max-height: 400px; overflow: hidden; width: 100%;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{ asset('landscaping.jpg') }}" alt="Landscape Services" style="object-fit: cover; max-height: 400px; filter: brightness(80%);">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('swimmingpool.jpg') }}" alt="SwimmingPool Services" style="object-fit: cover; max-height: 400px; filter: brightness(80%);">
            <div class="carousel-caption d-none d-md-block text-left">
                <h5 class="font-weight-bold text-white display-4">Swimming Pool Services</h5>
                <p class="lead text-white">Dive into luxury with our expert swimming pool design and maintenance services.</p>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('renovation.jpg') }}" alt="Renovation Services" style="object-fit: cover; max-height: 400px; filter: brightness(80%);">
            <div class="carousel-caption d-none d-md-block text-left">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('maintenance.jpg') }}" alt="Maintenance Services" style="object-fit: cover; max-height: 400px; filter: brightness(80%);">
            <div class="carousel-caption d-none d-md-block text-left">
...
<div class="container-fluid p-0">
    <div class="jumbotron jumbotron-fluid text-white" style="background: linear-gradient(135deg, #28a745, #218838);">
        <div class="container">
            <h1 class="display-3 font-weight-bold">Transform Your Outdoors with Arfil's Landscaping Services</h1>
            <p class="lead">We offer a comprehensive range of services to make your outdoor space beautiful and functional.</p>
            <p>From landscaping to swimming pool design, renovation, and maintenance, we have the expertise to bring your vision to life.</p>
            <hr class="my-4 border-light">
            <div class="d-flex flex-column flex-md-row">
                <a class="btn btn-lg btn-light btn-outline-success mr-md-3 mb-3 mb-md-0" href="{{ route('booking.form') }}" role="button" style="transition: all 0.3s ease; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);">Schedule Site Visit</a>
                <a class="btn btn-lg btn-success text-white" href="{{ route('quotation.create') }}" role="button" style="transition: all 0.3s ease; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);">Get a Quote</a>
            </div>
        </div>
    </div>
</div>
 ...
 <style>
        ...
        .btn-outline-success, .btn-outline-primary, .btn-outline-danger, .btn-outline-warning {
...
<body>
    ...
    <div class="placeholder" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px; padding: 30px;">
        ...
        <div class="card hover-effect" style="width: 300px; cursor: pointer;"
            ...
            <div class="card-body text-center">
                ...
                <a href="{{ route('services.byCategory', ['category' => 'landscaping']) }}" class="btn btn-outline-success">View Services</a>
            </div>
        </div>
        ...
        <div class="card hover-effect" style="width: 300px; cursor: pointer;"
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text">Dive into luxury with our professional swimming pool design and maintenance services.</p>
                <a href="{{ route('services.byCategory', ['category' => 'swimmingpool']) }}" class="btn btn-outline-primary">View Services</a>
            </div>
        </div>
        ...
        <div class="card hover-effect" style="width: 300px; cursor: pointer;"
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text">Revitalize your space with our renovation services, tailored to your vision.</p>
                <a href="{{ route('services.byCategory', ['category' => 'renovation']) }}" class="btn btn-outline-danger">View Services</a>
            </div>
        </div>
        ...
        <div class="card hover-effect" style="width: 300px; cursor: pointer;"
            ...
            <div class="card-body text-center">
                ...
                <a href="{{ route('services.byCategory', ['category' => 'maintenance']) }}" class="btn btn-outline-warning">View Services</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 slide-up">
                <div class="card shadow-lg border-0" style="border-radius: 15px;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">To provide exceptional landscaping services that transform outdoor spaces.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 slide-up">
                <div class="card shadow-lg border-0" style="border-radius: 15px;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">To become a leading provider of innovative landscaping solutions in the region.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 slide-up">
                <div class="card shadow-lg border-0" style="border-radius: 15px;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">To improve our services and contribute to environmental conservation.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="contact" class="mt-5 text-center">
        ...
        <div class="mt-5">
            ...
            <a href="https://www.facebook.com/profile.php?id=100087594043346" class="btn btn-primary btn-lg mx-3 zoom-in" 
            ...
            <a href="https://mail.google.com/mail/u/0/#inbox?compose=jrjtXFBjqfMzNMcCpJTDGhPJRdkVjFQVJCkKrZlcNZPzQqJFBXcGMdvbnZsxqSgQgGDtffdG" 
               class="btn btn-danger btn-lg mx-3 zoom-in" 
               style="border-radius: 50px; width: 200px;">
